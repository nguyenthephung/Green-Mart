  ...
  static async getUserAddresses(req: Request, res: Response): Promise<void> {
    try {
      ...
      const response: AddressResponse[] = addresses.map(addr => ({
        ...
        label: `${addr.street}, ${addr.ward}, ${addr.district}, ${addr.city || ''}`,
    ...
    try {
      ...
      try {
        ...
        const response: AddressResponse = {
          ...
          label: `${savedAddress.street}, ${savedAddress.ward}, ${savedAddress.district}, ${savedAddress.city || ''}`,
          address: `${savedAddress.street}, ${savedAddress.ward}, ${savedAddress.district}, ${savedAddress.city || ''}`,
