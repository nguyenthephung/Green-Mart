          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <label className="text-sm text-gray-700 dark:text-gray-300">Sản phẩm sắp hết hàng</label>
                  <input
                    type="checkbox"
                ...
                <div className="flex items-center justify-between">
                  <label className="text-sm text-gray-700 dark:text-gray-300">Cập nhật hệ thống</label>
                  <input
                    type="checkbox"
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <label className="text-sm text-gray-700 dark:text-gray-300">Số mục trên mỗi trang</label>
                  <select
                ...
                <div className="flex items-center justify-between">
                  <label className="text-sm text-gray-700 dark:text-gray-300">Chế độ xem mặc định</label>
                  <select
                ...
                <div className="flex items-center justify-between">
                  <label className="text-sm text-gray-700 dark:text-gray-300">Hiển thị xem trước</label>
                  <input
                    type="checkbox"
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <label className="text-sm text-gray-700 dark:text-gray-300">Thời gian hết phiên (phút)</label>
                  <input
                    type="number"
                    min="5"
                    max="120"
                ...
                <div className="flex items-center justify-between">
                  <label className="text-sm text-gray-700 dark:text-gray-300">Yêu cầu đổi mật khẩu định kỳ</label>
                  <input
                    type="checkbox"
                ...
                <div className="flex items-center justify-between">
                  <label className="text-sm text-gray-700 dark:text-gray-300">Xác thực 2 yếu tố</label>
                  <input
                    type="checkbox"
