          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <button
                ...
                style={
                  isDarkMode
                    ? { backgroundColor: '#23272f', borderColor: '#374151', color: '#fff' }
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <p>
                  <span className="font-medium">Mã theo dõi:</span> {order.trackingCode}
                </p>
                <p>
                  <span className="font-medium">Trạng thái:</span> {getStatusText(order.status)}
                </p>
                <p>
            ...
            <div className="space-y-3">
              {order.items.map((item: any) => (
                <div
                  ...
                  style={isDarkMode ? { borderColor: '#374151' } : { borderColor: '#d1d5db' }}
                >
                  {item.image && (
                    <img
                      src={item.image}
          ...
          <div className="mt-8">
            ...
            <div className="space-y-4">
              {trackingHistory.map((item: any) => (
                <div
                  key={item._id}
                  className="bg-white dark:bg-slate-800 rounded-lg shadow p-4 flex flex-col md:flex-row md:items-center md:gap-4"
                >
                  <div className="flex-1">
                ...
                <div className="flex gap-2">
                  <div className="flex flex-col w-1/4">
                    ...
                    <span className="text-xs text-gray-500 mt-1">
                      Nhập vĩ độ GPS, ví dụ: 10.762622
                    </span>
                  </div>
                  <div className="flex flex-col w-1/4">
                    <input
                    ...
                    />
                    <span className="text-xs text-gray-500 mt-1">
                      Nhập kinh độ GPS, ví dụ: 106.660172
                    </span>
                  </div>
                  <div className="flex flex-col w-1/3">
                    <input
                  ...
                  <div className="flex flex-col w-1/4">
                    ...
                    />
                    <span className="text-xs text-gray-500 mt-1">
                      Ví dụ: Đang giao, Đã đến kho, Đang chuyển phát...
                    </span>
                  </div>
                </div>
                <button
