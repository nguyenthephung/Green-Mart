          ...
          >
            <tr>
              ...
              <th
                ...
                onClick={() => onSort('id')}
              >
                <div className="flex items-center gap-1">Mã đơn {getSortIcon('id')}</div>
              </th>
              <th
                className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors"
              ...
              >
                <div className="flex items-center gap-1">Ngày đặt {getSortIcon('orderDate')}</div>
              </th>
          ...
          >
            {currentOrders.map((order: Order) => (
              <tr
                key={order.id}
                style={{
                  ...(isDarkMode ? { backgroundColor: '#18181b' } : { backgroundColor: '#fff' }),
                  transition: 'none',
                }}
                onMouseEnter={e => {
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="space-y-1">
                    <span
                      className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium border ${getPaymentMethodColor(order.paymentMethod)}`}
                    >
