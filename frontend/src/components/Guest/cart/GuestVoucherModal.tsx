  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[121] flex justify-center items-center p-4 overflow-y-auto">
        <div
          className="bg-white rounded-3xl shadow-2xl mx-auto relative flex flex-col animate-slideInFromBottom my-8"
          style={{ minWidth: '320px', maxWidth: '440px', width: '100%' }}
        >
          {/* Header */}
          ...
          <div className="p-6">
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                Đăng nhập để xem và sử dụng các mã giảm giá độc quyền dành cho thành viên của
                GreenMart
              </p>
