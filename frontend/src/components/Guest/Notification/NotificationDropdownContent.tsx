...
const NotificationDropdownContent: React.FC<NotificationDropdownContentProps> = ({ onClose }) => {
  ...
  return (
    <div className="w-full max-w-sm sm:max-w-xl lg:max-w-2xl xl:max-w-4xl bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 max-h-[70vh] sm:max-h-[80vh] overflow-hidden">
      {/* Header */}
                ...
                <div className="flex items-start gap-2 sm:gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between mb-1">
                      <h4
                        className={`text-xs sm:text-sm font-medium text-gray-900 dark:text-gray-100 line-clamp-2 pr-2 ${
                      ...
                      <div className="flex items-center gap-1 flex-shrink-0">
                        {notification.priority && (
                          <span
                            className={`px-1.5 py-0.5 text-[10px] sm:text-xs font-medium rounded-full ${getPriorityColor(notification.priority)}`}
                          >
                        ...
                        >
                          <Trash2
                            size={10}
                            className="text-red-500 dark:text-red-400 sm:w-3 sm:h-3"
                          />
                        </button>
                      </div>
                    </div>
