...
const Header: React.FC = memo(() => {
  ...
  const shouldHideCategoryBar =
    location.pathname.includes('order-success') ||
    location.pathname.includes('guest-order-success');
        ...
        <div className="flex justify-between items-center h-16">
          ...
          >
            <div className="relative">
              ...
              />
              <div
                className={`absolute -top-1 -right-1 bg-green-500 rounded-full animate-pulse ${isMobile ? 'w-3 h-3' : 'w-4 h-4'}`}
              ></div>
            </div>
            {!isMobile && (
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-green-600 font-medium -mt-1">Fresh & Organic</span>
                </div>
              </div>
            )}
          </div>
