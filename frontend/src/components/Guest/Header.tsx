                ...
                >
                  ...
                  >
                    <div className="relative">
                      <Bell size={18} />
                      {unreadCount > 0 && (
                        <span className="absolute -top-1 -right-1 bg-red-500 text-white text-[10px] font-bold rounded-full h-4 w-4 flex items-center justify-center min-w-[16px] border border-white dark:border-gray-800">
              ...
              <CartIconWrapper>
                ...
                >
                  <div className="relative">
                    ...
                    {cartCount > 0 && (
                      <span className="absolute -top-1 -right-1 bg-gradient-to-r from-red-500 to-pink-500 text-white text-[10px] rounded-full w-4 h-4 flex items-center justify-center shadow-lg border border-white dark:border-gray-800 font-bold min-w-[16px]">
