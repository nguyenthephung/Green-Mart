...
const ProductCard: React.FC<ProductCardProps> = memo(({ product, onAddToCart, showSaleBadge = true }) => {
  ...
  try {
    wishlistHooks = useWishlistStore();
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-xl transform transition-all duration-400 hover:shadow-2xl dark:shadow-gray-900/50 hover:-translate-y-2 perspective-1000 relative">
      ...
      <button
        ...
        className="mt-2 w-full bg-green-600 dark:bg-green-700 hover:bg-green-700 dark:hover:bg-green-600 text-white px-4 py-2 rounded-md shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-200 flex items-center justify-center gpu-accelerated"
      >
