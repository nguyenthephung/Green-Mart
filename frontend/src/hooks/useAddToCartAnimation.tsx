...
export const useAddToCartAnimation = () => {
  const triggerAnimation = useCallback(({ sourceElement, targetElement, onComplete }: AddToCartAnimationOptions) => {
    ...
    flyingElement.className = 'fixed pointer-events-none z-[9999] transition-all duration-700 ease-out';
