...
const AccountDetails: React.FC = () => {
  ...
  const [avatar, setAvatar] = useState(
    user?.avatar || `https://i.pravatar.cc/120?u=${user?.email || 'user'}`
  );
    ...
    return (
      <DashboardLayout>
        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg max-w-2xl mx-auto mt-6 border border-gray-200 dark:border-gray-600">
          <LoadingSpinner size="md" text="Đang tải thông tin..." />
        </div>
      </DashboardLayout>
    );
  }
          ...
          <div className="relative group">
            ...
            {editMode && (
              <label className="absolute bottom-1 right-1 sm:bottom-2 sm:right-2 bg-app-input rounded-full p-1.5 sm:p-2 shadow-lg cursor-pointer hover:bg-green-50 dark:hover:bg-gray-500 transition-all group-hover:scale-110">
                <svg
                  className="w-4 h-4 sm:w-5 sm:h-5 text-brand-green"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
                  viewBox="0 0 24 24"
        ...
        <div className="bg-app-card rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg border-app-default">
          <form className="space-y-8">
            ...
            <div className="group">
              <label
                htmlFor="full-name"
                className="flex items-center gap-3 font-semibold text-app-primary mb-3"
              >
              ...
              <input
                ...
                className={`w-full px-4 py-4 border-2 rounded-xl shadow-sm transition-all duration-200 ${
                  editMode ? 'form-control-focus' : 'form-control-disabled'
                ...
                >
                  ...
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M15 7a2 2 0 012 2m0 0a2 2 0 012 2m-2-2v6m0 0a2 2 0 01-2 2m2-2h-6m6 0a2 2 0 01-2 2m0 0H9a2 2 0 01-2-2m0 0V9a2 2 0 012-2m0 0a2 2 0 012-2"
                    />
                  </svg>
                  Đổi mật khẩu
                </Link>
