      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Chúng tôi cam kết mang đến những sản phẩm tươi ngon, chất lượng cao và dịch vụ tận tâm
            nhất cho khách hàng
          </p>
        </div>
        ...
        <div className="space-y-8">
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              GreenMart được thành lập với sứ mệnh mang đến cho người tiêu dùng Việt Nam những sản
              phẩm thực phẩm tươi ngon, an toàn và chất lượng cao. Chúng tôi hiểu rằng thực phẩm
              không chỉ đơn thuần là nguồn dinh dưỡng, mà còn là nền tảng cho sức khỏe và hạnh phúc
              của mỗi gia đình.
            </p>
            <p className="text-gray-700 leading-relaxed">
              Với hệ thống cửa hàng hiện đại và dịch vụ giao hàng tận nơi, GreenMart cam kết đem đến
              trải nghiệm mua sắm thuận tiện và đáng tin cậy cho mọi khách hàng.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Mọi sản phẩm đều được kiểm tra kỹ lưỡng về nguồn gốc và chất lượng
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Hệ thống logistics hiện đại đảm bảo giao hàng nhanh và an toàn
                  </p>
                </div>
              </div>
