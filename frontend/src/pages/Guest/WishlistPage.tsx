      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Danh sách yêu thích trống</h3>
            <p className="text-gray-600 mb-6">
              Bạn chưa có sản phẩm nào trong danh sách yêu thích. Hãy khám phá và thêm những sản
              phẩm bạn thích!
            </p>
            <Link
              to="/category"
          ...
          <div className="grid gap-3 lg:gap-4">
            {items.map(item => (
              <div
                ...
                className="bg-white rounded-2xl shadow-sm p-4 lg:p-6 hover:shadow-md transition-shadow"
              >
                <div
                  className={`flex items-center gap-3 lg:gap-6 ${isMobile ? 'flex-col sm:flex-row' : ''}`}
                >
                  {/* Product Image */}
                  ...
                  <div className="flex-1">
                    ...
                    >
                      <span
                        className={`font-bold text-green-600 ${isMobile ? 'text-lg' : 'text-xl'}`}
                      >
