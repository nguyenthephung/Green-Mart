...
const Checkout = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-green-50 via-white to-emerald-50 min-h-screen flex flex-col">
      <Header />
          ...
          {canCheckout ? (
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-red-100">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">Bạn cần đăng nhập để tiếp tục thanh toán đơn hàng.</p>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-orange-100">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Chưa có địa chỉ giao hàng</h3>
                <p className="text-gray-600 mb-6">Bạn cần thêm địa chỉ giao hàng để tiếp tục thanh toán.</p>
                <div className="flex gap-4 justify-center">
                  <button 
