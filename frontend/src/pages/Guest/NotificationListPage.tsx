          ...
          <div className="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center">
            ...
            >
              <path
                ...
                d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m6.75 4.5v-3a1.5 1.5 0 011.5-1.5h3a1.5 1.5 0 011.5 1.5v3m-6 0h4.5m0 0h2.625a1.125 1.125 0 001.125-1.125V11.25a1.125 1.125 0 00-1.125-1.125H15.75m-6.75 0H9.375a1.125 1.125 0 01-1.125-1.125V5.625m8.25 0h2.25a1.125 1.125 0 011.125 1.125v1.5m0 0H15.75m0 0v3M12 7.5V6a1.5 1.5 0 00-1.5-1.5h-3A1.5 1.5 0 006 6v1.5h6z"
              />
            </svg>
          </div>
        );
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-2">
                          <div
                            className={`font-semibold text-lg ${isRead ? 'text-gray-600' : 'text-gray-900'}`}
                          >
                            {n.status}
                          </div>
                          {!isRead && <div className="w-3 h-3 bg-blue-500 rounded-full"></div>}
                        </div>
                        <div
                          ...
                          dangerouslySetInnerHTML={{
                            __html: n.desc
                              .replace(
                                n.orderId,
                                `<span class="font-semibold text-green-600">${n.orderId}</span>`
                              )
                              .replace(
                                n.tracking || '',
                                n.tracking
                                  ? `<span class="font-semibold text-blue-600">${n.tracking}</span>`
                                  : ''
                              ),
                          }}
                        />
