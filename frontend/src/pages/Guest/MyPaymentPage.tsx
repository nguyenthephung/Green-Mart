        ...
        <div className="bg-app-card rounded-2xl shadow-lg border-app-default p-6">
          {payments.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-semibold text-app-primary mb-2">Chưa có phương thức thanh toán</h3>
              <p className="text-app-secondary mb-6">Thêm phương thức thanh toán để thanh toán dễ dàng hơn</p>
              <button 
            ...
            <div className="space-y-4">
              {payments.map((payment) => (
                <div key={payment.id} className="bg-app-secondary rounded-xl p-6 border-app-border hover:shadow-lg transition-all duration-200 group">
          ...
          <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 z-50">
            <div className="bg-app-card rounded-3xl shadow-2xl w-full max-w-md mx-4 p-8">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-app-primary mb-2">Thêm phương thức thanh toán</h3>
                <p className="text-app-secondary">Nhập thông tin phương thức thanh toán mới</p>
              </div>

              <div className="space-y-6">
                <div>
                  <label htmlFor="method" className="block text-sm font-semibold text-app-secondary mb-2">
                    Phương thức thanh toán
                  </label>
                  <input
                    id="method"
                ...
                <div>
                  <label htmlFor="expiry" className="block text-sm font-semibold text-app-secondary mb-2">
                    Ngày hết hạn
                  </label>
                  <input
                    id="expiry"
