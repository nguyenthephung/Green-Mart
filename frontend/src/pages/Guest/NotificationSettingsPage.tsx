    ...
    <DashboardLayout>
      <div className="bg-white dark:bg-gray-950 p-4 sm:p-6 lg:p-8 rounded-2xl sm:rounded-3xl shadow-xl">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Quản lý các loại thông báo bạn muốn nhận</p>
        </div>
        ...
        <div className="bg-blue-50 dark:bg-gray-950 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div>
                <div className="text-xl sm:text-2xl font-bold text-gray-900">{notificationTypes.length}</div>
        ...
        <div className="bg-white dark:bg-gray-950 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8">
          <div className="space-y-4 sm:space-y-6">
            {notificationTypes.map(({ key, label, description, icon }) => {
              ...
              return (
                <div key={key} className={`p-4 sm:p-6 rounded-xl sm:rounded-2xl transition-all duration-300 ${
                  ...
                  <div className="flex items-start sm:items-center gap-4 sm:gap-6">
                    <div className="flex-shrink-0">
                      ...
                      <div className="sm:hidden">
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                          key === 'order' ? 'bg-green-500' : key === 'promotion' ? 'bg-orange-500' : 'bg-blue-500'
                        }`}>
                          <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                            {key === 'order' && <path strokeLinecap="round" strokeLinejoin="round" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />}
                            {key === 'promotion' && <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />}
                            {key === 'system' && <path strokeLinecap="round" strokeLinejoin="round" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />}
                          </svg>
                        </div>
                      </div>
                      {/* Desktop icon */}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start sm:items-center justify-between gap-3 mb-2">
                        <div className="flex-1 min-w-0">
                          <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-200">{label}</h3>
