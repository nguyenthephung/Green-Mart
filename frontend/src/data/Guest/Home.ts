export const slides = [
  { id: 1, image: 'https://placehold.co/1200x400?text=Slide+1', title: 'Chào Mừng đến GreenMart', subtitle: 'Siêu thị tiện lợi cho mọi nhà!' },
  { id: 2, image: 'https://placehold.co/1200x400?text=Slide+2', title: 'Tươi Ngon Mỗi Ngày', subtitle: 'Thực phẩm sạch, an toàn, giá tốt!' },
  { id: 3, image: 'https://placehold.co/1200x400?text=Slide+3', title: 'Ưu Đãi Đặc Biệt', subtitle: 'Mua nhiều tiết kiệm nhiều!' },
];
