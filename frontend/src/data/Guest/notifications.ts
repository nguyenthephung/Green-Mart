...
export const notifications = [
  ...
  { id: 3, type: 'system', title: 'Cập nhật chính sách bảo mật', time: '1 ngày trước', read: false },
  { id: 4, type: 'review', title: 'Hãy đánh giá sản phẩm bạn đã mua', time: '2 ngày trước', read: true },
];
